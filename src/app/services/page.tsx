...
const services = [
  {
    ...
    desc: 'Establish authority with a premium digital presence. We build robust, scalable websites that reflect your leadership and professionalism.',
    features: ['Custom Design Systems', 'Enterprise Security', 'Seamless CMS Integration', 'Performance Optimized', 'Global Accessibility']
  },
  {
    icon: '🚀', title: 'High-Converting Landing Pages',
    desc: 'Every pixel is engineered to guide visitors toward a single, powerful call to action. We combine psychological triggers with speed.',
    features: ['Conversion Optimization', 'A/B Test Ready', 'Fast Loading Times', 'Responsive Layouts', 'Integrated Analytics']
  },
  {
    icon: '🛒', title: 'E-Commerce Solutions',
    desc: 'Full-featured online stores built for growth. From secure checkouts to inventory management, we handle the tech so you can sell.',
    features: ['Secure Payments', 'Inventory Sync', 'Headless Commerce', 'Mobile-First UI', 'Customer Portals']
  },
  {
    icon: '🎨', title: 'UI/UX Design Systems',
    desc: 'Bespoke design systems that ensure brand consistency across all platforms. Beautiful, intuitive, and modern user experiences.',
    features: ['Component Libraries', 'Brand Guidelines', 'Interactive Prototypes', 'Accessibility Audit', 'Dark / Light Modes']
  },
  {
    icon: '🔍', title: 'Advanced SEO Strategy',
    desc: 'Deep-level technical and content-driven SEO. We ensure search engines love your site as much as your users do.',
    features: ['Schema Markup', 'Core Web Vitals', 'Technical Audit', 'Keyword Strategy', 'Ranking Monitoring']
  },
  {
    icon: '🏗️', title: 'SaaS & Web Applications',
    desc: 'Building high-performance dashboards and AI-integrated portals. Scalable logic meets modern user interface.',
    features: ['Full-Stack Logic', 'AI API Integration', 'Scalable Architecture', 'Secure Auth', 'Fast Deployments']
  },
]
  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-badge sa-up" id="heroBadge"><span className="badge-dot"></span>Our Services</div>
        <h1 className="hero-h1 sa-up" id="heroH1">
          Elite <span className="line-gradient">Solutions</span> for Growth
        </h1>
        <p className="hero-sub sa-up" id="heroSub">We offer a range of specialized digital services designed to help you dominate your industry through speed and design.</p>
      </section>

      {/* ── SERVICES GRID ── */}
      <section className="services-list" id="all-services">
        <div className="container">
          <div className="services-header">
            ...
            <p className="section-sub sa-up">Six core service areas, all delivered with the same speed, quality, and attention to detail.</p>
          </div>
          <div className="services-grid">
            {services.map(svc => (
              <div key={svc.title} className="feat-card sa-up svc-card">
                <div className="feat-icon">{svc.icon}</div>
                <h3 className="feat-title">{svc.title}</h3>
                <p className="feat-desc svc-desc">{svc.desc}</p>
      ...
      <section className="services-pricing">
        <div className="container" style={{ maxWidth: '680px' }}>
          <div className="services-pricing-inner sa-up">
            <span className="section-label">Pricing</span>
            <h2 className="section-title">Plans Starting at ₹4,999</h2>
