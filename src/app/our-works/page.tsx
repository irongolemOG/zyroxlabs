...
export const metadata: Metadata = {
  title: 'Our Works | Premium Portfolio | Zyrox Labs',
  description: 'Explore our portfolio of high-performance websites, from luxury fashion ateliers to technical electronics studios. Elite digital products delivered in 48h.',
  alternates: {
    canonical: 'https://zyroxlabs.in/our-works',
  },
}
...
const FALLBACK_PROJECTS = [
  {
    ...
    description: 'A premium, luxurious digital storefront for a high-end clothing boutique. Featuring smooth parallax effects and a minimalist, elite aesthetic.',
  ...
  {
    id: 102,
    title: 'Sansun Electronics',
    industry: 'Service',
    category: 'Technical Portal',
    description: 'A high-converting local service portal for a premium electronics repair studio. Optimized for speed and local search dominance.',
    link: 'https://sansunservicecenter.in/',
    image_url: 'https://images.unsplash.com/photo-1588508065123-287b28e013da?auto=format&fit=crop&q=80&w=800'
  },
  {
    id: 103,
    title: 'Sri Mahaveer Jain Pashu Seva',
    industry: 'Non-Profit',
    category: 'NGO Platform',
    description: 'A compassionate mission-driven website for animal welfare. Engineered to maximize trust, donations, and volunteer engagement.',
    link: 'https://srimahaveerjainpashusevakendra.in/',
  ...
  },
  {
    ...
    description: 'A modern, professional showcase for a leading chemical distribution enterprise. Clean, informative, and authoritative.',
    link: 'https://skechem.co.in',
    image_url: 'https://images.unsplash.com/photo-1532187863486-abf51ad990de?auto=format&fit=crop&q=80&w=800'
  },
  {
    id: 105,
    title: 'Superbhumans',
    ...
    description: 'A sleek, dynamic digital presence designed for high-ticket coaching clients. Featuring AI-integrated logic and premium animations.',
  ...
  {
    id: 106,
    title: 'Aspire Corporation',
    industry: 'Corporate',
    category: 'Industrial Enterprise',
    description: 'A futuristic corporate website built for scale and authority. Designed to communicate reliability to global enterprise partners.',
