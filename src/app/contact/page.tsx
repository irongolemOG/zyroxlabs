...
export const metadata: Metadata = {
  title: 'Contact Us | Get Your Premium Website | Zyrox Labs',
  description: 'Ready to build your digital presence? Contact Zyrox Labs today for a free quote. We build and launch in 48 hours.',
  alternates: {
    canonical: 'https://zyroxlabs.in/contact',
  },
}
  ...
  return (
    <>
      ...
      <section className="hero" style={{ minHeight: '55vh', paddingBottom: '0' }}>
        ...
        <div className="hero-badge sa-up" id="heroBadge"><span className="badge-dot"></span>Contact</div>
        <h1 className="hero-h1 sa-up" id="heroH1">
          Let's Build Something <span className="line-gradient">Amazing</span>
        </h1>
        <p className="hero-sub sa-up" id="heroSub">Have a project in mind? We'd love to hear from you. Get in touch and let's start building your digital future.</p>
      </section>
